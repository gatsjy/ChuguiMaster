...
카카오톡, 메모장 텍스트 및 엑셀 파일 형태로 입력된 하객 축의금 명단을 인공지능 스마트 파서로 1초 만에 자동 정산하고, 감사 인사말까지 클립보드로 복사/발송할 수 있는 스마트 경조사 정산 솔루션입니다.

---

## ⚡ 1초 무설치 실행 방법 (비개발자용 초간단 안내)

컴퓨터에 파이썬이나 복잡한 프로그램이 설치되어 있지 않아도 **바로 더블 클릭 한 번**으로 시작할 수 있습니다!

### 💻 일반 사용자 실행 (추천 🌟)
1. **`dist` 폴더**로 이동합니다.
2. **`ChuguiMaster.exe`** (또는 `ChuguiMaster-Single.exe`) 파일을 **더블 클릭**합니다.
3. 프로그램을 바로 사용하시면 끝납니다! (별도 설치 필요 없음)
...
### 💡 주요 기능
- **1초 복사 버튼**: 각 하객 행의 `[📋 복사]` 버튼 또는 `Ctrl+C`를 누르면, 하객 이름과 축의금에 맞춘 감사 인사말이 즉시 클립보드에 복사됩니다.
- **예시 메세지**:
