...
> 🔒 **개인정보 보호(Anonymization) 완벽 보장**: 본 문서에 작성된 모든 예시 데이터 및 수치(`1,250,000원`, `5건` 등)는 **Qt `widget.grab()` 동적 익명 UI 캡처 기술**을 통해 실제 하객 개인정보 노출 없이 100% 가상 데이터(`홍길동`, `김철수`, `이영희`, `박민수`, `최동욱`)로 생성된 화면입니다.
...
```
 ┌─────────────────────────┐  ┌─────────────────────────┐  ┌─────────────────────────┐  ┌─────────────────────────┐
 │ 💵 총 수령 축의금       │  │ 👥 하객 통계            │  │ 🍽️ 총 식대              │  │ 💰 최종 순 정산금       │
 │ 1,250,000원             │  │ 5건                     │  │ 275,000원               │  │ 975,000원               │
 │ 현금 1,250,000 · 이체 0 │  │ 5명 · 참석 5 · 불참 0   │  │ 대인 5장 · 소인 0장     │  │ 총 축의금 − 총 식대     │
 └─────────────────────────┘  └─────────────────────────┘  └─────────────────────────┘  └─────────────────────────┘
```
...
```
 🍽️ 식대 단가   [ 대인  55,000원 ▲▼ ]   [ 소인  32,000원 ▲▼ ]   총 식대 = 대인 식권 × 대인 단가 + 소인 식권 × 소인 단가
```
...
| NO | 성명 (가상) | 금액 | 관계 (드롭다운 태그) | 참석여부 | 수령방식 | 식권 (대/소) | 동작 |
| :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **1** | **홍길동** | `200,000원` | `[ 친척 ▼ ]` | `[ 참석 ▼ ]` | `[ 현금 ▼ ]` | `1 / 0` | `[ 📋 복사 ]` |
| **2** | **김철수** | `100,000원` | `[ 친구 ▼ ]` | `[ 참석 ▼ ]` | `[ 현금 ▼ ]` | `1 / 0` | `[ 📋 복사 ]` |
| **3** | **이영희** | `300,000원` | `[ 직장 ▼ ]` | `[ 참석 ▼ ]` | `[ 현금 ▼ ]` | `1 / 0` | `[ 📋 복사 ]` |
| **4** | **박민수** | `150,000원` | `[ 교회 ▼ ]` | `[ 참석 ▼ ]` | `[ 현금 ▼ ]` | `1 / 0` | `[ 📋 복사 ]` |
| **5** | **최동욱** | `500,000원` | `[ 친척 ▼ ]` | `[ 참석 ▼ ]` | `[ 현금 ▼ ]` | `1 / 0` | `[ 📋 복사 ]` |
